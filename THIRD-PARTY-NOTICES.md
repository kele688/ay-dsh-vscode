...
This project bundles the following third-party packages (production dependency closure at build time, 542 packages). All licenses are permissive open-source licenses compatible with redistribution under MIT.

Generated by `node scripts/scan-licenses.mjs`. Last generated: 2026-09-12
